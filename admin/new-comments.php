...
<!DOCTYPE html>
<head>
<title>Food Recipe System | New Comments </title>
 ...
 <div class="card">
    ...
    <div>
      <table class="table" ui-jq="footable" ui-options='{
        ...
        <?php
$ret=mysqli_query($con,"SELECT recipes.recipeTitle,recipes.id as rid, comments.* FROM `comments` join recipes on recipes.id=comments.recipeId where comments.status is null");
$cnt=1;
        ...
        <tbody>
          <tr data-expanded="true">
            ...
            <td><?php  echo $row['userName'];?></td>
              ...
              <td><button class="btn btn-warning btn-sm">Waiting for Approval</button></td>
                  <td><?php  echo $row['postingDate'];?></td>
                  <td>
                     <a href="new-comments.php?action=approve&&cid=<?php echo $row['id']; ?>"  title="Approve this comment" onclick="return confirm('Do you really want to approve this comment?');" class="btn btn-success btn-sm">Approve </a>
