 ...
 <div class="card">
    ...
    <div>
      <table class="table" ui-jq="footable" ui-options='{
        ...
        <?php
$ret=mysqli_query($con,"SELECT recipes.recipeTitle,recipes.id as rid, comments.* FROM `comments` join recipes on recipes.id=comments.recipeId where comments.status='1'");
$cnt=1;
