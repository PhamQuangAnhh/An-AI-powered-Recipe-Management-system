...
<header class="header fixed-top clearfix">
    <!-- Brand -->
    <div class="brand">
        <a href="dashboard.php" class="logo">FRS Admin</a>
...
$header_ret = mysqli_query($con, "SELECT AdminName FROM admins WHERE ID='$adid'");
$header_row = mysqli_fetch_array($header_ret);
$name = $header_row['AdminName'] ?? 'Admin';
?>
